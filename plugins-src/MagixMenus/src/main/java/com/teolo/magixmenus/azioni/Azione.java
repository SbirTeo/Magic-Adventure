 ...
 */
public record Azione(Tipo tipo, String argomento, Requisiti condizione,
                     List<Azione> allora, List<Azione> altrimenti) {

    /** Azione semplice: tipo e argomento, senza condizioni. */
    public static Azione di(Tipo tipo, String argomento) {
        return new Azione(tipo, argomento, Requisiti.NESSUNO, List.of(), List.of());
    }
