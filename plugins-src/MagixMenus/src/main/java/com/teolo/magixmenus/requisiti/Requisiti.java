 ...
 */
public record Requisiti(List<Requisito> elenco, int minimo, List<Azione> azioniNegate) {

    /** Nessuna condizione: sempre soddisfatto. E' il valore di chi non scrive niente nel file. */
    public static final Requisiti NESSUNO = new Requisiti(List.of(), 0, List.of());
