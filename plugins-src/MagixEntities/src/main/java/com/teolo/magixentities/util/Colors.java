...
public final class Colors {
    ...
    /**
     * Testo con codici & (ed esadecimali &#RRGGBB) convertito in Component Adventure:
     * serve per i nomi delle entita', che sull'API moderna non accettano piu' le stringhe §.
     */
