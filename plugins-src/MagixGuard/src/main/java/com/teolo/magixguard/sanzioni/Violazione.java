 ...
 */
public record Violazione(int id, UUID uuid, String nome, String categoria, int punti,
                         String fonte, String dettaglio, long quando) {

    public static Violazione nuova(UUID uuid, String nome, String categoria, int punti,
                                   String fonte, String dettaglio) {
        return new Violazione(0, uuid, nome, categoria, punti, fonte, dettaglio,
