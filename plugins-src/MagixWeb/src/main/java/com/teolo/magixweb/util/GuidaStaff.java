package com.teolo.magixweb.util;
 ...
 * come {@code Aiuto}: se la si modifica in uno, va riportata in tutti. Vedi
 ...
 * <pre>
 * GuidaStaff.crea(this, "MagixTime — ora e stagioni reali", 60)
...
public final class GuidaStaff {
     ...
     *  del config (vedi {@link ValoriConfig}). Va chiamato SUBITO dopo crea(), prima dei testi. */
    private ValoriConfig valori;

    private GuidaStaff(JavaPlugin plugin, String titolo, int ordine) {
        this.plugin = plugin;
        this.titolo = titolo;
        this.ordine = ordine;
     ...
     *               giorno sta in cima.
     */
    public static GuidaStaff crea(JavaPlugin plugin, String titolo, int ordine) {
        return new GuidaStaff(plugin, titolo, ordine);
    }
     ...
     */
    public GuidaStaff valori(ValoriConfig valori) { this.valori = valori; return this; }

    /** Applica i segnaposto, se la guida e' stata legata al config con {@link #valori(ValoriConfig)}. */
    ...
    public GuidaStaff intro(String testo) {
        testo = sost(testo);
    ...
    public GuidaStaff sezione(String titolo, String... paragrafi) {
        titolo = sost(titolo);
     ...
     */
    public GuidaStaff comandiDettagliati() {
     ...
     */
    public GuidaStaff sottocomandi(String titolo, String... comandoESpiegazione) {
     ...
     */
    public GuidaStaff impostazioni(String... chiaveESpiegazione) {
     ...
     */
    public GuidaStaff impostazioniDa(org.bukkit.configuration.Configuration conf, String titolo,
