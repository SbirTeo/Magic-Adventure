...
ALTER TABLE store_packages
    ADD COLUMN image_position    VARCHAR(20) NOT NULL DEFAULT '50% 50%' AFTER image_url,       -- telefono
    ADD COLUMN image_position_pc VARCHAR(20) NOT NULL DEFAULT '50% 50%' AFTER image_position;  -- computer
